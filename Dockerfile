...
RUN apk add python3~=3.10 py3-pip build-base python3-dev musl-dev libffi-dev openssl-dev py3-virtualenv rust cargo
...
RUN apk add python3~=3.10 py3-pip bash git openssh firefox
